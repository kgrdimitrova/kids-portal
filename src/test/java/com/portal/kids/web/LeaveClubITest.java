...
public class LeaveClubITest {
    ...
    @Test
    @Transactional
    void shouldLeaveUserFromClub_success() {
        ...
        Club club = clubRepository.save(
                Club.builder()
                        ...
                        .createdOn(LocalDate.of(2025, 12, 01))
                        .updatedOn(LocalDate.of(2025, 12, 02))
                        .build()
        );
    ...
    @Test
    @Transactional
    void shouldThrowException_whenUserIsNotInClub() {
    ...
    void shouldThrowException_whenUserDoesNotExist() {
        ...
        assertThatThrownBy(() -> userClubService.removeUserFromClub(invalidUserId, club.getId()))
                .isInstanceOf(RuntimeException.class)
    ...
    void shouldThrowException_whenClubDoesNotExist() {
        ...
        assertThatThrownBy(() -> userClubService.removeUserFromClub(user.getId(), invalidClubId))
                .isInstanceOf(RuntimeException.class)
