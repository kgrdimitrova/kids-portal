...
public class EventService {
    ...
    public List<Event> getActiveEventsByClubId(Status status, UUID clubId) {
        return eventRepository.findEventByStatusAndClubIdOrderByStartDateAsc(status, clubId);
    }
    ...
    private Event generateEvent(Event initialEvent, LocalDate current) {
        return Event.builder()
                ...
                .imageUrl(initialEvent.getImageUrl())
